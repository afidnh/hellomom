...
public class DetailTanya extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private static final String url_detail = Server.URL + "/android/detail_tanya.php";
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST, url_detail, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    judul.setText("Pertanyaan : "+Judul);
                    tgl.setText(Tgl);
                    isi.setText(Html.fromHtml("Jawaban :"+Isi));

                    if (obj.getString(TAG_GAMBAR) != "") {
                        thumb_image.setImageUrl(Server.URL +Gambar, imageLoader);
                    }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(DetailTanya.this,
